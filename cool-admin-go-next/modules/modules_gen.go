...
func buildbasegithub_com_toothdy_cool_admin_go_next_modules_base_serviceNewInitializer(dependency0 *coredb.Runtime, dependency1 seed.Data, dependency2 coreentity.Descriptor[entity.Conf, uint64], dependency3 coreentity.Descriptor[entity.Department, uint64], dependency4 coreentity.Descriptor[entity.Menu, uint64], dependency5 coreentity.Descriptor[entity.Param, uint64], dependency6 coreentity.Descriptor[entity.Role, uint64], dependency7 coreentity.Descriptor[entity.User, uint64], dependency8 coreentity.Descriptor[entity.UserRole, uint64]) (*service.Initializer, error) {
	return service.NewInitializer(dependency0, dependency1, dependency2, dependency3, dependency4, dependency5, dependency6, dependency7, dependency8)
}
...
func buildbasegithub_com_toothdy_cool_admin_go_next_modules_base_controller_admin_sysNewMenuToolHandler(dependency0 base.Config, dependency1 *service.MenuService, dependency2 *service.PermissionService) (*sys.MenuToolHandler, error) {
...
func generatedGraph() module.Graph {
	return module.MustBuildGraph(module.GraphInput{
		...
		Routes: []coreroute.Definition{
			...
			{Controller: "base:github.com/toothdy/cool-admin-go-next/modules/base/controller/admin/sys.AdminSysUserController", Kind: coreroute.KindCustom, Method: "POST", Path: "/admin/base/sys/user/add", Summary: "新增", Description: "", DevelopmentOnly: false, Bind: coreroute.BindJSON, Handler: coreroute.CallableRef{PackagePath: "github.com/toothdy/cool-admin-go-next/modules/base/controller/admin/sys", Symbol: "UserHandler", Method: "Add", Type: "*github.com/toothdy/cool-admin-go-next/modules/base/controller/admin/sys.UserHandler", HasRequest: true, RequestPackagePath: "github.com/toothdy/cool-admin-go-next/modules/base/dto", RequestType: "UserAddReq", ReturnsValue: true}, Permission: "base:sys:user:add"},
			...
			{Controller: "base:github.com/toothdy/cool-admin-go-next/modules/base/controller/admin/sys.AdminSysUserController", Kind: coreroute.KindCustom, Method: "POST", Path: "/admin/base/sys/user/page", Summary: "分页查询", Description: "", DevelopmentOnly: false, Bind: coreroute.BindJSON, Handler: coreroute.CallableRef{PackagePath: "github.com/toothdy/cool-admin-go-next/modules/base/controller/admin/sys", Symbol: "UserHandler", Method: "Page", Type: "*github.com/toothdy/cool-admin-go-next/modules/base/controller/admin/sys.UserHandler", HasRequest: true, RequestPackagePath: "github.com/toothdy/cool-admin-go-next/modules/base/dto", RequestType: "UserPageReq", ReturnsValue: true}, Permission: "base:sys:user:page", Transaction: coreroute.NonTransactional()},
		...
		Providers: []module.ProviderDefinition{
			...
			{Kind: module.ProviderKindSeed, Module: "base", PackagePath: "github.com/toothdy/cool-admin-go-next/cool-next/seed", Name: "Data", Type: "github.com/toothdy/cool-admin-go-next/cool-next/seed.Data"},
...
func assemble(ctx context.Context, input app.AssembleInput, identity0 module.Identity) (*app.Assembly, error) {
	...
	epsViews, err := eps.CompileViews(eps.Input{Graph: generatedGraph(), Controllers: []eps.ControllerSpec{
		{Key: "base:github.com/toothdy/cool-admin-go-next/modules/base/controller/admin/sys.AdminSysDepartmentController", Descriptor: descriptor_basegithub_com_toothdy_cool_admin_go_next_modules_base_entityDepartment},
		{Key: "base:github.com/toothdy/cool-admin-go-next/modules/base/controller/admin/sys.AdminSysLogController", Descriptor: descriptor_basegithub_com_toothdy_cool_admin_go_next_modules_base_entityLog},
		{Key: "base:github.com/toothdy/cool-admin-go-next/modules/base/controller/admin/sys.AdminSysMenuController", Descriptor: descriptor_basegithub_com_toothdy_cool_admin_go_next_modules_base_entityMenu},
		{Key: "base:github.com/toothdy/cool-admin-go-next/modules/base/controller/admin/sys.AdminSysParamController", Descriptor: descriptor_basegithub_com_toothdy_cool_admin_go_next_modules_base_entityParam},
		{Key: "base:github.com/toothdy/cool-admin-go-next/modules/base/controller/admin/sys.AdminSysRoleController", Descriptor: descriptor_basegithub_com_toothdy_cool_admin_go_next_modules_base_entityRole},
		{Key: "base:github.com/toothdy/cool-admin-go-next/modules/base/controller/admin/sys.AdminSysUserController", Descriptor: descriptor_basegithub_com_toothdy_cool_admin_go_next_modules_base_entityUser},
	}}, gmode.IsDevelop())
	if err != nil {
